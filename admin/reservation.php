...
<head>
    ...
    <title>RESERVATION WATERWAVE HOTEL</title>
	<!-- Bootstrap Styles-->
                            ...
                            <div class="form-group">
							  ...
							  <div class="form-group">
							   ...
							   <div class="form-group">
								...
								$countries = array( "Azerbaijan","India", "Bahamas", "Bahrain", "Bangladesh", "Barbados", "Belarus", "Belgium", "Belize", "Benin", "Bermuda", "Bhutan", "Bolivia", "Bosnia and Herzegowina", "Botswana", "Bouvet Island", "Brazil", "British Indian Ocean Territory", "Brunei Darussalam", "Bulgaria", "Burkina Faso", "Honduras", "Hong Kong", "Hungary", "Iceland", "Indonesia");
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="well">
                        ...
                        <p> Type Below this code <?php  $Random_code=rand(9,9999 ); echo$Random_code; ?> </p><br />
